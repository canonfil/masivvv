public class Main {
    public static void main(String[] args) {
        ...
        int minPayment = monthPayments[0];
        ...
        for (int payment : monthPayments) {
            ...
            System.out.println("Минимальная сумма трат на неделю составила " + minPayment + "P" +
                    " Максимальная сумма трат на неделю составила " + maxPayment + " P");
